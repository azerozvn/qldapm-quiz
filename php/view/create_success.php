...
<div class="container create-page">
    <div class="create-heading text-center">
        ...
        <input class="form-control" type="text" readonly value="<?php echo parseUrl("php/play.php?link=".$data['PLAY-LINK']); ?>"><br>
        <a href="<?php echo parseUrl("php/play.php?link=".$data['PLAY-LINK']); ?>"> <span class="fa fa-link"></span> Play quiz</a><br>
    </div>
</div>
